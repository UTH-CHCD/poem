...
DROP TABLE IF EXISTS dev.poem_codeset_delivery;

CREATE TABLE dev.poem_codeset_delivery (
...
INSERT INTO dev.poem_codeset_delivery (code_set, code, description, cd_cleaned) VALUES
